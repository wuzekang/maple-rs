...
fn main() -> anyhow::Result<()> {
    run(AppConfig::default(), || {
        ...
        let root = view()
            ...
            .child((
                // Title
                text("TextInput Component Example")
                    .style(|s| {
                        s.font_size(24.0)
                ...
                view()
                    ...
                    .child((
                        ...
                        view().style(|s| s.flex().flex_col().gap(8.0)).child((
                            text("Email").style(|s| {
                                s.font_size(14.0)
                                    .color(Color::from_rgb8(55, 65, 81))
                            }),
                            text_input()
                        ...
                        view().style(|s| s.flex().flex_col().gap(8.0)).child((
                            text("Nickname (max 10 characters)").style(|s| {
                                s.font_size(14.0)
                                    .color(Color::from_rgb8(55, 65, 81))
                            }),
                            text_input()
                ...
                view()
                    ...
                    .child((
                        text("Real-time Preview:").style(|s| {
                            s.font_size(14.0)
                                .color(Color::from_rgb8(30, 64, 175)) // blue-800
                        }),
                        dynamic_text(move || format!("Username: {}", username.read().clone()))
                            .style(|s| {
                                s.font_size(14.0)
                                    .color(Color::from_rgb8(59, 130, 246)) // blue-500
                            }),
                ...
                // Instructions
                text("Tip: Click input box to focus, press ESC to lose focus")
                    .style(|s| {
                        s.font_size(12.0)
